...
/*     */ 
/*     */ 
/*     */ public abstract class LbsEditorPaneAdapterBase
/*     */   implements ILbsEditorPane, ILbsComponentAdapter
/*     */ {
/*     */   private final ILbsEditorPane delegate;
/*     */   
/*     */   protected LbsEditorPaneAdapterBase(ILbsEditorPane delegate) {
...
/* 399 */     return this.delegate.getContentType();
/*     */   }
/*     */ 
/*     */   
/*     */   public String getOriginalText() {
/* 404 */     return this.delegate.getOriginalText();
/*     */   }
/*     */ 
/*     */   
/*     */   public int getTextLimit() {
/* 409 */     return this.delegate.getTextLimit();
/*     */   }
/*     */ 
/*     */   
/*     */   public void scrollToReference(String reference) {
/* 414 */     this.delegate.scrollToReference(reference);
/*     */   }
/*     */ 
/*     */   
/*     */   public void setContentType(String type) {
/* 419 */     this.delegate.setContentType(type);
/*     */   }
/*     */ 
/*     */   
/*     */   public void setTextLimit(int limit) {
/* 424 */     this.delegate.setTextLimit(limit);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 433 */     return this.delegate.getCaretPosition();
/*     */   }
/*     */ 
/*     */   
/*     */   public Color getDisabledTextColor() {
/* 438 */     return this.delegate.getDisabledTextColor();
/*     */   }
/*     */ 
/*     */   
/*     */   public String getSelectedText() {
/* 443 */     return this.delegate.getSelectedText();
/*     */   }
/*     */ 
/*     */   
/*     */   public Color getSelectedTextColor() {
/* 448 */     return this.delegate.getSelectedTextColor();
/*     */   }
/*     */ 
/*     */   
/*     */   public Color getSelectionColor() {
/* 453 */     return this.delegate.getSelectionColor();
/*     */   }
/*     */ 
/*     */   
/*     */   public int getSelectionEnd() {
/* 458 */     return this.delegate.getSelectionEnd();
/*     */   }
/*     */ 
/*     */   
/*     */   public int getSelectionStart() {
/* 463 */     return this.delegate.getSelectionStart();
/*     */   }
/*     */ 
/*     */   
/*     */   public String getText() {
/* 468 */     return this.delegate.getText();
/*     */   }
/*     */ 
/*     */   
/*     */   public String getText(int offs, int len) throws BadLocationException {
/* 473 */     return this.delegate.getText(offs, len);
/*     */   }
/*     */ 
/*     */   
/*     */   public boolean isEditable() {
/* 478 */     return this.delegate.isEditable();
/*     */   }
/*     */ 
/*     */   
/*     */   public void replaceSelection(String content) {
/* 483 */     this.delegate.replaceSelection(content);
/*     */   }
/*     */ 
/*     */   
/*     */   public void select(int selectionStart, int selectionEnd) {
/* 488 */     this.delegate.select(selectionStart, selectionEnd);
/*     */   }
/*     */ 
/*     */   
/*     */   public void selectAll() {
/* 493 */     this.delegate.selectAll();
/*     */   }
/*     */ 
/*     */   
/*     */   public void setCaretPosition(int position) {
/* 498 */     this.delegate.setCaretPosition(position);
/*     */   }
/*     */ 
/*     */   
/*     */   public void setDisabledTextColor(Color c) {
/* 503 */     this.delegate.setDisabledTextColor(c);
/*     */   }
/*     */ 
/*     */   
/*     */   public void setEditable(boolean editable) {
/* 508 */     this.delegate.setEditable(editable);
/*     */   }
/*     */ 
/*     */   
/*     */   public void setSelectedTextColor(Color c) {
/* 513 */     this.delegate.setSelectedTextColor(c);
/*     */   }
/*     */ 
/*     */   
/*     */   public void setSelectionColor(Color c) {
/* 518 */     this.delegate.setSelectionColor(c);
/*     */   }
/*     */ 
/*     */   
/*     */   public void setSelectionEnd(int selectionEnd) {
/* 523 */     this.delegate.setSelectionEnd(selectionEnd);
/*     */   }
/*     */ 
/*     */   
/*     */   public void setSelectionStart(int selectionStart) {
/* 528 */     this.delegate.setSelectionStart(selectionStart);
/*     */   }
/*     */ 
/*     */   
/*     */   public void setText(String text) {
/* 533 */     this.delegate.setText(text);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Furkan\Desktop\logo\Components.jar!\com\lbs\control\interfaces\adapters\base\LbsEditorPaneAdapterBase.class
